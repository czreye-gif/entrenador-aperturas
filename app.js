...
const PIECE_SVG={
  p:'<ellipse class="sh" cx="50" cy="91" rx="24" ry="5"/><circle class="bd" cx="50" cy="30" r="11"/><path class="bd" d="M42 38c-5 4-8 12-9 26h34c-1-14-4-22-9-26z"/><path class="bd" d="M31 62h38c3 0 5 3 4 6l-2 9H29l-2-9c-1-3 1-6 4-6z"/>',
  n:'<ellipse class="sh" cx="50" cy="91" rx="27" ry="5"/><path class="bd" d="M56 16c-9 0-17 5-24 14-4 5-8 12-9 22-.4 4 .3 7 2 9h7c0-5 2-9 5-12-1 4-1 8 0 11h33c3-15 3-30-3-41-2-4-6-13-11-13z"/><path class="mane" d="M56 16c3 0 6 5 8 9-4-2-8-2-12 0 1-4 2-9 4-9z"/><circle class="ey" cx="40" cy="40" r="2.6"/><path class="bd" d="M29 66h42c3 0 5 3 4 6l-2 9H27l-2-9c-1-3 1-6 4-6z"/>',
  b:'<ellipse class="sh" cx="50" cy="91" rx="25" ry="5"/><circle class="bd" cx="50" cy="17" r="5"/><path class="bd" d="M50 23c-10 0-17 11-17 24 0 7 3 13 8 16h18c5-3 8-9 8-16 0-13-7-24-17-24z"/><path class="cut" d="M50 36l7 10H43z"/><path class="bd" d="M31 65h38c3 0 5 3 4 6l-2 10H29l-2-10c-1-3 1-6 4-6z"/>',
  r:'<ellipse class="sh" cx="50" cy="91" rx="26" ry="5"/><path class="bd" d="M29 22h7v6h6v-6h6v6h6v-6h7v15l-6 6v20H35V43l-6-6z"/><rect class="bd" x="35" y="58" width="30" height="6"/><path class="bd" d="M27 66h46c3 0 5 3 4 6l-2 10H25l-2-10c-1-3 1-6 4-6z"/>',
  q:'<ellipse class="sh" cx="50" cy="91" rx="27" ry="5"/><circle class="bd" cx="26" cy="28" r="4.5"/><circle class="bd" cx="38" cy="22" r="4.5"/><circle class="bd" cx="50" cy="19" r="4.5"/><circle class="bd" cx="62" cy="22" r="4.5"/><circle class="bd" cx="74" cy="28" r="4.5"/><path class="bd" d="M26 31l7 33h34l7-33-13 14-5-18-6 20-6-20-5 18z"/><path class="bd" d="M30 60h40c3 0 4 2 4 5l-1 5H31l-1-5c0-3 1-5 4-5z"/><path class="bd" d="M27 72h46c3 0 5 3 4 6l-2 8H25l-2-8c-1-3 1-6 4-6z"/>',
  k:'<ellipse class="sh" cx="50" cy="91" rx="27" ry="5"/><path class="bd" d="M46 8h8v6h6v7h-6v7h-8v-7h-6v-7h6z"/><path class="bd" d="M50 30c-12 0-21 9-21 21 0 6 2 10 5 13-3 2-5 5-6 9h44c-1-4-3-7-6-9 3-3 5-7 5-13 0-12-9-21-21-21z"/><path class="bd" d="M28 71h44c3 0 5 3 4 6l-2 9H26l-2-9c-1-3 1-6 4-6z"/>'
};
...
function renderBoard(){
  ...
  rO.forEach(r=>{ fO.forEach(f=>{
    ...
    const pc=grid[r][f]; if(pc){ const sp=el('span','piece '+pc.color); sp.innerHTML='<svg viewBox="0 0 100 100" aria-hidden="true">'+PIECE_SVG[pc.type]+'</svg>'; cell.appendChild(sp); }
