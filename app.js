...
function autoAdvance(){
  ...
  maybeReveal(); updateTurn(); renderBoard(); renderLog();
...
function renderBoard(){
  ...
  rO.forEach(r=>{ fO.forEach(f=>{
    ...
    const pc=grid[r][f]; if(pc){ const sp=el('span','piece '+pc.color); sp.textContent=GLYPH[pc.type]; cell.appendChild(sp); }
