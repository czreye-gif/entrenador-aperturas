...
Piezas de ajedrez: puedes elegir entre dos sets en Ajustes — **Merida** de Armando Hernández Marroquín, y **Cburnett** de Colin M.L. Burnett. Ambos del proyecto [Lichess](https://github.com/lichess-org/lila) bajo licencia libre. Atribución completa en `pieces/merida/CREDITS.txt` y `pieces/cburnett/CREDITS.txt`.
